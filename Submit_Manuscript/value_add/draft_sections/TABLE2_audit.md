...
|---|---|---|---|---|---|---|---|
| **CD55** | Wang 2024 | blood+retina | 3.6e-05 | 0.808 | 0.088 | 0.104 | reproduced (coloc+replication) |
| TSSK6 | Wang 2024 | blood+retina | 3.6e-06 | 0.782 | 0.173 | 0.045 | not_reproduced_coloc_low |
| SH3YL1 | Multi-omics 2024 | blood(SMR/mQTL) | 4.0e-02 | 0.748 | 0.085 | 0.167 | not_reproduced_coloc_low |
| WNT3 | Wang 2024 | blood+retina | — | 0.119 | 0.019 | 0.861 | not_reproduced_coloc_low |
| ZKSCAN4 | Multi-omics 2024 | blood(SMR/mQTL) | 2.0e-03 | 0.021 | 0.064 | 0.916 | not_reproduced_coloc_low |
| BTN3A1 | Wang 2024 | blood+retina | 8.9e-02 | 0.002 | 0.029 | 0.968 | not_reproduced_coloc_low |
| LCAT | Wang 2024 | blood+retina | 5.4e-01 | 0.000 | 0.042 | 0.957 | not_reproduced_coloc_low |
| NPAT | Multi-omics 2024 | blood(SMR/mQTL) | 4.4e-04 | 0.000 | 0.000 | 0.203 | not_reproduced_coloc_low |
| CD34 | Wang 2024 | blood+retina | 4.6e-01 | 0.000 | 0.212 | 0.787 | not_reproduced_coloc_low |
...
*Caveats:* Wang 2024 nominations used blood **and retina** eQTL; this audit is
